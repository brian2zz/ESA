        ...
        <div class="card">
            <div class="container-fluid">
                <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Laporan Stok Opnam</h2>
                ...
                <div class="card-header">
                    <div class="modal-body">
                        <form action="/laporan-opnam/search" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control selectpicker" name="bulan" id="#">
                    ...
                    <div class="container-fluid">
                        <div class="card-header">
                            ...
                            <button class="btn btn-primary mr-3 btn-sm "
                                onclick="tablesToExcel(['export_laporan_opnam'], 'LaporanOpnam' , 'Laporan Opnam.xls', 'Excel')">Export
                                Excel</button>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                @include('laporan.table.table_opnam')
                            </div>
                        </div>
                    </div>
                </div>
